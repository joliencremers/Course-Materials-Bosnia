...
|:------------|:------------------------------------------------|
| *Tuesday*   |                                                 |
| 09.00-12.00 | Repetition                                      |
|             | *Break*                                         |    
| 13.00-15.30 | Statistical Inference                           |
| *Wednesday* |                                                 |
| 09.00-12.00 | Linear Models (G)                               |
|             | *Break*                                         |             
| 13.00-15.30 | Generalized Linear Models (H)                   |
| *Thursday*  |                                                 |
| 09.00-12.00 | Data Validation and Editing                     |
|             | *Break*                                         |
| 13.00-15.30 | Imputation                                      |
| *Friday*    |                                                 |
...
- Part G: Statistical Inference
    - [Lecture G](Contents/Material/Part G - Statistical inference/Lecture_G.html){target="_blank"}
    - [Lecture G Handout](Contents/Material/Part G - Statistical inference/Lecture_G_handout.html){target="_blank"}
    - [Practical G](Contents/Material/Part G - Statistical inference/Practical_G_walkthrough.html){target="_blank"}
    - [Impractical G](Contents/Material/Part G - Statistical inference/Practical_G.html){target="_blank"}
...
- Part H: `R` Linear Models
    - [Lecture H](Contents/Material/Part H - Statistical inference/Lecture_H.html){target="_blank"}
    - [Lecture H Handout](Contents/Material/Part H - Statistical inference/Lecture_H_handout.html){target="_blank"}
    - [Practical H](Contents/Material/Part H - Statistical inference/Practical_H_walkthrough.html){target="_blank"}
    - [Impractical H](Contents/Material/Part H - Statistical inference/Practical_H.html){target="_blank"}
...
- Part ??: Data Validation and Editing
